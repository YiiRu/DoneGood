...
public class TokenDocCluster {

    public static void main(String[] args) throws Exception {
//        File dir = new File(args[0]);
        File dir = new File("D:/Play/Data/test");
    ...
    static class Document {
        final File mFile;   //the file from which it was generated
        final char[] mText; // the chars making up its text; don't really need to store
        final ObjectToCounterMap<String> mTokenCounter
            = new ObjectToCounterMap<String>(); //a token counter
        final double mLength; //a length
